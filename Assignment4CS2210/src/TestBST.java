...
public class TestBST {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("going inside the getter ");
			res = tree.get(tree.getRoot(),points[0]); // Look for existent data
			
			if (res.getColor() == colors[0])
				System.out.println("Test 1 passed");
			else System.out.println("Test 1 failed but wasn't an exception");
		}
		catch(Exception e) {
		...
		try {
			...
			System.out.println("Test 2 failed but was an exception");
		}
		...
		try {
			...
			System.out.println("Test 6 failed due to exception");
		}
		...
		try {
			...
			res = tree.get(tree.getRoot(),p);
			if (res != null) System.out.println("Test 12 failed 1");
			else {
			    res = tree.get(tree.getRoot(),new Location(1,0));
			    if (res == null) System.out.println("Test 12 failed 2 ");
			    else {
				res = tree.get(tree.getRoot(),new Location(19,10));
				if (res == null) System.out.println("Test 12 failed 3");
